...
let language = "en";
try {
  const stored = localStorage.getItem("playpicker-language");
  if (stored === "es" || stored === "en") language = stored;
} catch {}
const SPANISH = {
  "PlayPicker — Little ideas. Big adventures.":
    "PlayPicker — Pequeñas ideas. Grandes aventuras.",
  "Less screen time, more play time. Discover simple, creative activities for your family with PlayPicker.":
    "Menos pantallas, más juego. Descubre actividades sencillas y creativas para tu familia con PlayPicker.",
  ...
  "Keep what you love. Skip what you don’t.":
    "Guarda lo que te guste. Pasa lo demás.",
  "← Pass for now": "← Ahora no",
  "Save for later ♡ →": "Guardar para después ♡ →",
  "Real-world fun. Right at your fingertips.":
    "Diversión de verdad. Al alcance de tu mano.",
  ...
  "Swipe left to pass · swipe right to save":
    "Izquierda para pasar · derecha para guardar",
  ...
  "Add PlayPicker to your home screen. No app store needed.":
    "Añade PlayPicker a tu pantalla de inicio. Sin tiendas de aplicaciones.",
  "On iPhone": "En iPhone",
  "Open this site in Safari, tap Share, then":
    "Abre esta página en Safari, toca Compartir y luego",
  ...
  "Open this site in Chrome, open the ⋮ menu, then choose":
    "Abre esta página en Chrome, abre el menú ⋮ y elige",
  "Add to Home screen": "Añadir a pantalla de inicio",
  or: "o",
  "Install app": "Instalar aplicación",
  "For installation and offline play, use an HTTPS address. Your saved activities stay in this browser on this device.":
    "Para instalar y jugar sin conexión, usa una dirección HTTPS. Las actividades guardadas se conservan en este navegador y dispositivo.",
  ...
  View: "Ver",
  Ages: "Edades",
  "Tap a heart on any activity to keep it here for another day.":
    "Toca el corazón de una actividad para guardarla aquí para otro día.",
  "No activities match just yet. Try a different filter or explore them all.":
    "No hay actividades que coincidan. Prueba otro filtro o explóralas todas.",
  "Saved for another little adventure ♡":
    "Guardada para otra pequeña aventura ♡",
  "Removed from your collection": "Eliminada de tu colección",
  "Saved for this visit. Browser storage is unavailable.":
    "Guardada durante esta visita. El almacenamiento del navegador no está disponible.",
  ...
  "You’ve explored these ideas. Your favorites are waiting in your collection.":
    "Ya has explorado estas ideas. Tus favoritas te esperan en tu colección.",
  "No ideas match these filters. Give your next adventure a little more room.":
    "No hay ideas con estos filtros. Amplía la búsqueda para encontrar tu próxima aventura.",
  ...
  "A LITTLE CREATIVITY GOES A LONG WAY":
    "UN POCO DE CREATIVIDAD LO CAMBIA TODO",
  "See what you’ll need": "Mira qué necesitas",
  "Use the left arrow to pass or right arrow to save. Use the buttons below as an alternative to swiping.":
    "Usa la flecha izquierda para pasar o la derecha para guardar. También puedes usar los botones de abajo en lugar de deslizar.",
  "It’s a little match! Saved to your collection ♥":
    "¡Esta es para ti! Guardada en tu colección ♥",
  saved: "guardada",
  passed: "descartada",
  "ideas remaining.": "ideas restantes.",
  "Last swipe undone. Give it another look.":
    "Último deslizamiento deshecho. Mírala otra vez.",
  "PlayPicker is ready on your home screen.":
    "PlayPicker ya está en tu pantalla de inicio.",
  "Low mess": "Poco que limpiar",
  "Medium mess": "Limpieza moderada",
  "High mess": "Mucho que limpiar",
  "Skip to activities": "Saltar a las actividades",
  "Find their next favorite thing to do.":
    "Encuentra su próxima aventura favorita.",
  "One simple idea at a time. Keep what you love. Skip what you don’t.":
    "Una idea sencilla cada vez. Guarda lo que te guste y pasa lo demás.",
  "No fancy supplies. No perfect results. Just time together.":
    "Sin materiales complicados ni resultados perfectos. Solo tiempo en familia.",
  "Open this site in Safari, tap Share, then Add to Home Screen. Leave Open as Web App enabled if shown, then tap Add.":
    "Abre esta página en Safari, toca Compartir y luego Añadir a pantalla de inicio. Mantén Abrir como app web activado si aparece y toca Añadir.",
  "Open this site in Chrome, open the ⋮ menu, then choose Add to Home screen or Install app.":
    "Abre esta página en Chrome, abre el menú ⋮ y elige Añadir a pantalla de inicio o Instalar aplicación.",
  "Your change is available for this visit only. Browser storage is unavailable.":
    "El cambio solo se conservará durante esta visita. El almacenamiento del navegador no está disponible.",
  "Age range: {range} years": "Edad: de {range} años",
  "Duration: {count} minutes": "Duración: {count} minutos",
  "Save {title}": "Guardar {title}",
  "Unsave {title}": "Quitar {title} de la colección",
...
const SPANISH_ACTIVITIES = {
  ...
  "living-room-trail": {
    ...
    description:
      "Una habitación cualquiera se convierte en una gran expedición.",
  ...
  "shadow-stories": {
    ...
    materials: ["Una linterna", "Una pared despejada", "Tus manos"],
    steps: [
  ...
  "leaf-rubbings": {
    ...
    materials: ["Hojas caídas", "Papel", "Ceras de colores grandes"],
    steps: [
...
function localizeActivity(activity) {
  return language === "es"
    ? { ...activity, ...SPANISH_ACTIVITIES[activity.id] }
    : activity;
}
...
// Explicit bindings preserve controls and state without scanning arbitrary text.
function translateStaticPage() {
  ...
  button.setAttribute(
    "aria-label",
    language === "en" ? "ES — Cambiar a español" : "EN — Switch to English",
  );
...
const MESSAGES = {
  collection: {
    en: {
      one: "{count} activity in your collection",
      other: "{count} activities in your collection",
    },
    es: {
      one: "{count} actividad en tu colección",
      other: "{count} actividades en tu colección",
    },
  },
  remaining: {
    en: {
      one: "{count} idea left to discover",
      other: "{count} ideas left to discover",
    },
    es: {
      one: "{count} idea por descubrir",
      other: "{count} ideas por descubrir",
    },
  },
  saved: {
    en: {
      one: "{title} saved. {count} idea remaining.",
      other: "{title} saved. {count} ideas remaining.",
    },
    es: {
      one: "Se ha guardado {title}. Queda {count} idea.",
      other: "Se ha guardado {title}. Quedan {count} ideas.",
    },
  },
  passed: {
    en: {
      one: "{title} passed. {count} idea remaining.",
      other: "{title} passed. {count} ideas remaining.",
    },
    es: {
      one: "Se ha descartado {title}. Queda {count} idea.",
      other: "Se ha descartado {title}. Quedan {count} ideas.",
    },
  },
};
...
function message(key, count, values = {}) {
  const forms = MESSAGES[key][language];
...
function textMessage(key, values) {
